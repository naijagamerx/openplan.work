        ...
        <form id="client-form" class="p-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" value="<?php echo e($client['name'] ?? ''); ?>" required
                ...
                <div>
                    ...
                    <input type="text" name="company" value="<?php echo e($client['company'] ?? ''); ?>"
                ...
                <div>
                    ...
                    <input type="email" name="email" value="<?php echo e($client['email'] ?? ''); ?>" required
                ...
                <div>
                    ...
                    <input type="url" name="website" value="<?php echo e($client['website'] ?? ''); ?>"
                           placeholder="https://..."
                           class="w-full px-4 py-3 border-2 border-gray-50 rounded-xl focus:border-black outline-none transition-colors font-medium">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="address" rows="3" 
                          ...
                          class="w-full px-4 py-3 border-2 border-gray-50 rounded-xl focus:border-black outline-none transition-all min-h-[80px] font-medium"><?php echo e($client['address'] ?? ''); ?></textarea>
            </div>
            ...
            <div class="pt-4">
                ...
                <textarea name="notes" rows="6" 
                          ...
                          class="w-full px-4 py-4 border-2 border-gray-50 rounded-2xl focus:border-black outline-none transition-all min-h-[150px] font-medium"><?php echo e($client['notes'] ?? ''); ?></textarea>
            ...
            <div class="flex justify-end gap-4 pt-8 border-t border-gray-100">
                <a href="?page=clients" class="px-8 py-3 text-gray-400 font-bold rounded-xl hover:text-black transition uppercase tracking-widest text-xs">Cancel</a>
                <button type="submit" class="px-10 py-3 bg-black text-white font-bold rounded-xl hover:bg-gray-800 transition shadow-lg uppercase tracking-widest text-xs">
...
document.getElementById('client-form').addEventListener('submit', async (e) => {
    ...
    if (response.success) {
        ...
        showToast(response.error || 'Failed to save client', 'error');
    }
});
...
async function generateBriefWithAI() {
    ...
    showToast('AI is drafting a brief...', 'info');
    
    // Using unified AI generate endpoint with custom prompt logic in AIHelper
